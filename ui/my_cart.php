                ...
                <div class="col-12">
                    <div class="row ec_breadcrumb_inner">
                        <div class="col-md-6 col-sm-12">
                            <h2 class="ec-breadcrumb-title">Purchase History & Orders</h2>
                        </div>
                        <div class="col-md-6 col-sm-12">
                ...
                <div class="ec-shop-rightside col-lg-12 col-md-12">
                    <div class="ec-vendor-dashboard-card">
                        <div class="ec-vendor-card-header">
                            <h5>Furnitures Purchase History</h5>
                            <div class="ec-header-btn">
                                <a class="btn btn-lg btn-primary" href="landing_furnitures">Shop Now</a>
                            </div>
                        </div>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <?php if ($rows['order_status'] == 'Pending') { ?>
                                                            <a data-bs-toggle="modal" href="#pay_<?php echo $rows['order_id']; ?>" class="text-success"> Pay</a>
                                                        <?php } ?>
                                                        <a data-bs-toggle="modal" href="#delete_<?php echo $rows['order_id']; ?>" class="text-danger"> Delete</a>
                                                    </td>
                                                </tr>
                                        <?php
                                                include('../app/modals/landing_orders.php');
                                            }
                                        } ?>
                                    </tbody>
                                </table>
