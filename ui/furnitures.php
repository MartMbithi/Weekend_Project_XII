                                    ...
                                    <div class="row">
                                        <div class="form-group col-md-6" style="display:none">
                                            ...
                                            <select type="text" required name="furniture_seller_id" class="form-control">
                                                ...
                                                $fetch_records_sql = mysqli_query(
                                                    $mysqli,
                                                    "SELECT * FROM furniture_seller WHERE 
                                                    seller_login_id = '{$_SESSION['login_id']}'"
                                                );
                                                if (mysqli_num_rows($fetch_records_sql) > 0) {
                                                    while ($rows = mysqli_fetch_array($fetch_records_sql)) {
                                                ?>
                                                        <option selected value="<?php echo $rows['seller_id']; ?>"><?php echo $rows['seller_first_name'] . ' ' . $rows['seller_last_name']; ?></option>
                                                <?php }
                                                } ?>
                                            </select>
                                        </div>
