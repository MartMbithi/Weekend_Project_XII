                ...
                <div class="col-md-12 text-center">
                    <div class="section-title">
                        ...
                        <p class="sub-title mb-3">
                            Enter your login username to reset password
                        </p>
                    </div>
                </div>
                        ...
                        <div class="ec-login-form">
                            <form method="post">
                                ...
                                <span class="ec-login-wrap ec-login-fp">
                                    <label><a href="login">Remember Password?</a></label>
                                </span>
                                <span class="ec-login-wrap ec-login-btn">
                                    <button class="btn btn-primary" name="Reset_Password_1" type="submit">Reset password</button>
                                </span>
                            </form>
                        </div>
                    </div>
