<!-- Edit -->
<div class="modal fade fixed-right" id="update_<?php echo $rows['admin_id']; ?>" role="dialog" aria-hidden="true">
                ...
                <form class="needs-validation" method="post" enctype="multipart/form-data" role="form">
                    <div class="row">
                        <div class="form-group col-md-6">
                            ...
                            <input type="hidden" required name="admin_id" value="<?php echo $rows['admin_id']; ?>" class="form-control">
                    ...
                    <div class="text-right">
                        <button type="submit" name="Update_Staff_Details" class="btn btn-outline-danger">Save</button>
                    </div>
                </form>
            </div>
        </div>
...
<!-- Delete -->
<div class="modal fade" id="delete_<?php echo $rows['admin_id']; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        ...
        <div class="modal-content">
            <form method="POST">
                <div class="modal-body text-center text-danger">
                    ...
                    <button type="submit" name="Delete_Staff_Details" class="text-center btn btn-danger">Yes, Delete</button>
                </div>
            </form>
        </div>
    </div>
